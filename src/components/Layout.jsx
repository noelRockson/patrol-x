...
const OfflineNotice = () => {
  ...
  return (
    <div className="fixed top-24 left-0 right-0 z-[3000] mx-auto max-w-md px-4">
...
const Layout = () => {
  ...
  return (
    <ErrorBoundary>
      <div className="h-screen flex flex-col relative bg-white dark:bg-black transition-all duration-500 pt-9">
        {/* Notice hors ligne */}
        <OfflineNotice />
